...
public class Followers extends AppCompatActivity implements CustonAdapter_Followers.customButtonListener_foollwers{
    ListView listView ;
    public final String FOLLOWER_URL = "http://thelinkweb.com/follow.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = (Toolbar)findViewById(R.id.toolbar_follower);
        ...
        mainlayout = (RelativeLayout) findViewById(R.id.mainlayoutfollower) ;
         nointernet = (RelativeLayout) findViewById(R.id.nointernetfollower);
       ...
       number =  PreferenceManager.getDefaultSharedPreferences(getApplicationContext()).getString("Number", "");
        ...
        FollowerAsync asyncTaskfollower =  new FollowerAsync();
    ...
    private BroadcastReceiver mConnReceiver = new BroadcastReceiver() {
        public void onReceive(Context context, Intent intent) {
            ...
            ProgressDialog loading = new ProgressDialog(Followers.this);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, FOLLOWER_URL,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(Followers.this,"Internal Error: Please try again..", Toast.LENGTH_LONG).show();
                    }
                }){
            @Override
...
//
        ...
        adapter_follower=new CustonAdapter_Followers(Followers.this, followers_namelist, profilepicture , followers_list);
        adapter_follower.setCustomButtonListner(Followers.this);
        listView.setAdapter(adapter_follower);
    }

    private class FollowerAsync extends AsyncTask<Void , Void, Void>{
        @Override
    ...
    public void onButtonClickListner(final int position,final String m_number, String name) {
        ...
        alertDialog = new AlertDialog.Builder(Followers.this).create(); //Read Update
      ...
      //  alertDialog.setMessage("Do you want to Unfollow " + followers_namelist.get(position));
        alertDialog.setButton(Dialog.BUTTON_POSITIVE, "Delete", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                SendingFollowerNumber(number, followers_list.get(position));
                Toast toast = Toast.makeText(Followers.this, "Deleted...", Toast.LENGTH_LONG);
    ...
    private void SendingFollowerNumber( final String user_number   , final String number_unfollow){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, UNFOLLOW_URL,
            ...
            protected Map<String,String> getParams(){
                ...
                params.put("number" , number_unfollow);
                params.put("sender",user_number);
                return params;
            }
        ...
        switch (item.getItemId()) {
            case android.R.id.home:
               /* Intent intent = new Intent(FriendRequest.this , Follow_Activity.class);
                ...
                finish();*/
                startActivity(new Intent(Followers.this, Profile_Activity.class));
