...
public class EdmSongs extends AppCompatActivity {

    private static final String TRENDING_SONGS = "http://thelinkweb.com/fetch_edm.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edm_songs);


        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar_edmsongs);
        toolbar.setTitle("");
        setSupportActionBar(toolbar);
        toolbar.setTitle("Edm Songs");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        toolbar.setTitleTextColor(getResources().getColor(R.color.holo_pink_));

        recyclerView = (RecyclerView)findViewById(R.id.recycle_view_edm);
    ...
    private BroadcastReceiver mConnReceiver = new BroadcastReceiver() {
        public void onReceive(Context context, Intent intent) {
            ...
            ProgressDialog loading = new ProgressDialog(EdmSongs.this);
    ...
    private void Getting_Edm_Songs(){
        StringRequest stringRequest = new StringRequest(Request.Method.POST, TRENDING_SONGS,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(EdmSongs.this, "Internal Error: Please try again..", Toast.LENGTH_LONG).show();
                    }
                }){
            @Override
    ...
    private void parseJSON(String response){
        ...
        try {
            ...
            mAdapter = new FourImageViewAdapter(EdmSongs.this,name , artist_name ,  pictures , download_link);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == android.R.id.home) {
            ...
            startActivity(new Intent(EdmSongs.this, Home_Download_Activity.class));
