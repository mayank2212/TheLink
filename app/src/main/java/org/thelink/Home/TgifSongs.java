...
public class TgifSongs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar_trendingsongs);
        toolbar.setTitle("");
        setSupportActionBar(toolbar);
        toolbar.setTitle("Tgif Songs");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        toolbar.setTitleTextColor(getResources().getColor(R.color.holo_pink_));

        recyclerView = (RecyclerView)findViewById(R.id.recycle_view_tgif);
    ...
    private BroadcastReceiver mConnReceiver = new BroadcastReceiver() {
        public void onReceive(Context context, Intent intent) {
            ...
            ProgressDialog loading = new ProgressDialog(TgifSongs.this);
    ...
    public void Getting_Trending_Songs(){
        StringRequest stringRequest = new StringRequest(Request.Method.POST, TRENDING_SONGS,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(TgifSongs.this, "Internal Error: Please try again..", Toast.LENGTH_LONG).show();
                    }
                }){
            @Override
    ...
    private void parseJSON(String response){
        ...
        try {
            ...
            mAdapter = new FourImageViewAdapter(TgifSongs.this,name , artist_name ,  pictures , download_link);
...
//
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == android.R.id.home) {
            ...
            startActivity(new Intent(TgifSongs.this, Home_Download_Activity.class));
