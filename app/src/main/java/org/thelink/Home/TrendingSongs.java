...
public class TrendingSongs extends AppCompatActivity {
    ...
    private static final String TRENDING_SONGS = "http://thelinkweb.com/mix_trending.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trending_songs2);

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar_trendingsongs2);
        toolbar.setTitle("");
        setSupportActionBar(toolbar);
        toolbar.setTitle("Treding Songs");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        toolbar.setTitleTextColor(getResources().getColor(R.color.holo_pink_));

        recyclerView = (RecyclerView)findViewById(R.id.recycle_view_trending);
    ...
    private BroadcastReceiver mConnReceiver = new BroadcastReceiver() {
        public void onReceive(Context context, Intent intent) {
            ...
            ProgressDialog loading = new ProgressDialog(TrendingSongs.this);
    ...
    private void Getting_Trending_Songs(){
        StringRequest stringRequest = new StringRequest(Request.Method.POST, TRENDING_SONGS,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(TrendingSongs.this, "Internal Error: Please try again..", Toast.LENGTH_LONG).show();
                    }
                }){
            @Override
    ...
    private void parseJSON(String response){
        ...
        try {
            ...
            mAdapter = new FourImageViewAdapter(TrendingSongs.this,name , artist_name ,  pictures , download_link);
            recyclerView.setAdapter(mAdapter);
            //listView.setAdapter(new FourImageViewAdapter(TgifSongs.this, name , artist_name ,  pictures , download_link));
...
//
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == android.R.id.home) {
            ...
            startActivity(new Intent(TrendingSongs.this, Home_Download_Activity.class));
